...
mod tests {
    ...
    #[test]
    fn track_point_validate_should_reject_out_of_range_coordinates() {
        let mut input = TrackPointInput {
            session_id: None,
            latitude: 91.0,
            longitude: 200.0,
            altitude: None,
    ...
    #[test]
    fn track_point_validate_should_require_timestamp() {
        ...
        let errors = input.validate().unwrap_err();
        assert_eq!(errors, vec!["timestamp is required".to_string()]);
    }
}
